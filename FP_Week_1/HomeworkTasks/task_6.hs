-- John likes to calculate the weight he can carry in order to avoid back pains...
...
canCarry c k w
 ...
 | (fromIntegral $ c) * w > k = "No" -- cast to Float in order to have a proper multiplication
 | otherwise = "Yes"